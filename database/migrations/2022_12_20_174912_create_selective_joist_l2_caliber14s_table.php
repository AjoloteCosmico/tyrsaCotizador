...
class CreateSelectiveJoistL2Caliber14sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('selective_joist_l2_caliber14s', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('selective_joist_l2_caliber14s');
    }
}
