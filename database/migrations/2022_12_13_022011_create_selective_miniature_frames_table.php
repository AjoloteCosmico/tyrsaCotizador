...
class CreateSelectiveMiniatureFramesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('selective_miniature_frames', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('selective_miniature_frames');
    }
}
