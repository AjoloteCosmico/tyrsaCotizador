...
class CreateSelectiveStructuralFramesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('selective_structural_frames', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('selective_structural_frames');
    }
}
