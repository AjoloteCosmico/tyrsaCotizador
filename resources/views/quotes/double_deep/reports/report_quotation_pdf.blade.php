                ...
                <div class="row">
                    <div class="col-sm-12 text-justify">
                        ...
                        <p>
                            ...
                            Algunas ventajas del sistema de Rack de Doble Profundidad, son las siguientes:<br><br><br>                                
                        ...
                        <p>
                            ...
                            Los sistemas de Rack Doble Profundidad normalmente están constituidos por Baterías Sencillas y 
                            ...
                            <table style="border: solid 1px">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="border: solid 1px" width="50%"></td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                        <tr>
                                            ...
                                            <td style="border: solid 1px">{{ $DoubleDeepHeavyLoadFrames->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepHeavyLoadFrames->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Marcos de Carga Pesada Modelo {{ $DoubleDeepHeavyLoadFrames->model }} con las siguientes características:<br>
                                                Calibre: {{ $DoubleDeepHeavyLoadFrames->caliber }}<br>                                                
                                                Carga Total Kg: {{ $DoubleDeepHeavyLoadFrames->total_load_kg }}<br>
                                                Total Postes: {{ $DoubleDeepHeavyLoadFrames->total_poles }}<br>
                                                Total Travesaños: {{ $DoubleDeepHeavyLoadFrames->total_crossbars }}<br>                                                
                                                Total Diagonales: {{ $DoubleDeepHeavyLoadFrames->total_diagonals }}<br>
                                                Total Placas: {{ $DoubleDeepHeavyLoadFrames->total_plates }}<br>
                                                Total Kg: {{ $DoubleDeepHeavyLoadFrames->total_kg }}<br>
                                                Total M<sup>2</sup>: {{ $DoubleDeepHeavyLoadFrames->total_m2 }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepMiniatureFrames)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepMiniatureFrames->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepMiniatureFrames->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Mini Marcos Modelo {{ $DoubleDeepMiniatureFrames->model }} con las siguientes características:<br>
                                                Calibre: {{ $DoubleDeepMiniatureFrames->caliber }}<br>                                                
                                                Carga Total Kg: {{ $DoubleDeepMiniatureFrames->total_load_kg }}<br>
                                                Total Postes: {{ $DoubleDeepMiniatureFrames->total_poles }}<br>
                                                Total Travesaños: {{ $DoubleDeepMiniatureFrames->total_crossbars }}<br>                                                
                                                Total Diagonales: {{ $DoubleDeepMiniatureFrames->total_diagonals }}<br>
                                                Total Placas: {{ $DoubleDeepMiniatureFrames->total_plates }}<br>
                                                Total Kg: {{ $DoubleDeepMiniatureFrames->total_kg }}<br>
                                                Total M<sup>2</sup>: {{ $DoubleDeepMiniatureFrames->total_m2 }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepStructuralFrames)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepStructuralFrames->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepStructuralFrames->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Marcos Estructurales Modelo {{ $DoubleDeepStructuralFrames->model }} con las siguientes características:<br>
                                                Calibre: {{ $DoubleDeepStructuralFrames->caliber }}<br>                                                
                                                Carga Total Kg: {{ $DoubleDeepStructuralFrames->total_load_kg }}<br>
                                                Total Postes: {{ $DoubleDeepStructuralFrames->total_poles }}<br>
                                                Total Travesaños: {{ $DoubleDeepStructuralFrames->total_crossbars }}<br>                                                
                                                Total Diagonales: {{ $DoubleDeepStructuralFrames->total_diagonals }}<br>
                                                Total Placas: {{ $DoubleDeepStructuralFrames->total_plates }}<br>
                                                Total Kg: {{ $DoubleDeepStructuralFrames->total_kg }}<br>
                                                Total M<sup>2</sup>: {{ $DoubleDeepStructuralFrames->total_m2 }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepJoistL2Caliber14S)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistL2Caliber14S->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistL2Caliber14S->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Viga tipo L 2.0 Calibre 14 con las siguientes características:<br>
                                                Capacidad de Carga: {{ $DoubleDeepJoistL2Caliber14S->loading_capacity }}<br>
                                                Largo en Metros: {{ $DoubleDeepJoistL2Caliber14S->length_meters }}<br>
                                                Peralte: {{ $DoubleDeepJoistL2Caliber14S->camber }}<br>
                                                Peso en Kg: {{ $DoubleDeepJoistL2Caliber14S->weight_kg }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepJoistL2Caliber14S->m2 }}<br>
                                                Largo: {{ $DoubleDeepJoistL2Caliber14S->length }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepJoistL25Caliber14S)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistL25Caliber14S->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistL25Caliber14S->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Viga tipo L 2.5 Calibre 14 con las siguientes características:<br>
                                                Capacidad de Carga: {{ $DoubleDeepJoistL25Caliber14S->loading_capacity }}<br>
                                                Largo en Metros: {{ $DoubleDeepJoistL25Caliber14S->length_meters }}<br>
                                                Peralte: {{ $DoubleDeepJoistL25Caliber14S->camber }}<br>
                                                Peso en Kg: {{ $DoubleDeepJoistL25Caliber14S->weight_kg }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepJoistL25Caliber14S->m2 }}<br>
                                                Largo: {{ $DoubleDeepJoistL25Caliber14S->length }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepJoistBox2Caliber14S)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistBox2Caliber14S->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistBox2Caliber14S->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Viga tipo Caja 2.0 Calibre 14 con las siguientes características:<br>
                                                Capacidad de Carga: {{ $DoubleDeepJoistBox2Caliber14S->loading_capacity }}<br>
                                                Largo en Metros: {{ $DoubleDeepJoistBox2Caliber14S->length_meters }}<br>
                                                Peralte: {{ $DoubleDeepJoistBox2Caliber14S->camber }}<br>
                                                Peso en Kg: {{ $DoubleDeepJoistBox2Caliber14S->weight_kg }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepJoistBox2Caliber14S->m2 }}<br>
                                                Largo: {{ $DoubleDeepJoistBox2Caliber14S->length }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepJoistBox25Caliber14S)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistBox25Caliber14S->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistBox25Caliber14S->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Viga tipo Caja 2.5 Calibre 14 con las siguientes características:<br>
                                                Capacidad de Carga: {{ $DoubleDeepJoistBox25Caliber14S->loading_capacity }}<br>
                                                Largo en Metros: {{ $DoubleDeepJoistBox25Caliber14S->length_meters }}<br>
                                                Peralte: {{ $DoubleDeepJoistBox25Caliber14S->camber }}<br>
                                                Peso en Kg: {{ $DoubleDeepJoistBox25Caliber14S->weight_kg }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepJoistBox25Caliber14S->m2 }}<br>
                                                Largo: {{ $DoubleDeepJoistBox25Caliber14S->length }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepJoistL2S)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistL2S->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistL2S->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Viga tipo L 2.0 Calibre {{ $DoubleDeepJoistL2S->caliber }} con las siguientes características:<br>
                                                Capacidad de Carga: {{ $DoubleDeepJoistL2S->loading_capacity }}<br>
                                                Largo en Metros: {{ $DoubleDeepJoistL2S->length_meters }}<br>
                                                Peralte: {{ $DoubleDeepJoistL2S->camber }}<br>
                                                Peso en Kg: {{ $DoubleDeepJoistL2S->weight_kg }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepJoistL2S->m2 }}<br>
                                                Largo: {{ $DoubleDeepJoistL2S->length }}<br>
                                                Patín: {{ $DoubleDeepJoistL2S->skate }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepJoistL25S)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistL25S->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistL25S->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Viga tipo L 2.5 Calibre {{ $DoubleDeepJoistL25S->caliber }} con las siguientes características:<br>
                                                Capacidad de Carga: {{ $DoubleDeepJoistL25S->loading_capacity }}<br>
                                                Largo en Metros: {{ $DoubleDeepJoistL25S->length_meters }}<br>
                                                Peralte: {{ $DoubleDeepJoistL25S->camber }}<br>
                                                Peso en Kg: {{ $DoubleDeepJoistL25S->weight_kg }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepJoistL25S->m2 }}<br>
                                                Largo: {{ $DoubleDeepJoistL25S->length }}<br>
                                                Patín: {{ $DoubleDeepJoistL25S->skate }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepJoistBox2S)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistBox2S->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistBox2S->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Viga tipo Caja 2.0 Calibre {{ $DoubleDeepJoistBox2S->caliber }} con las siguientes características:<br>
                                                Capacidad de Carga: {{ $DoubleDeepJoistBox2S->loading_capacity }}<br>
                                                Largo en Metros: {{ $DoubleDeepJoistBox2S->length_meters }}<br>
                                                Peralte: {{ $DoubleDeepJoistBox2S->camber }}<br>
                                                Peso en Kg: {{ $DoubleDeepJoistBox2S->weight_kg }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepJoistBox2S->m2 }}<br>
                                                Largo: {{ $DoubleDeepJoistBox2S->length }}<br>
                                                Patín: {{ $DoubleDeepJoistBox2S->skate }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepJoistBox25S)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistBox25S->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistBox25S->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Viga tipo Caja 2.5 Calibre {{ $DoubleDeepJoistBox25S->caliber }} con las siguientes características:<br>
                                                Capacidad de Carga: {{ $DoubleDeepJoistBox25S->loading_capacity }}<br>
                                                Largo en Metros: {{ $DoubleDeepJoistBox25S->length_meters }}<br>
                                                Peralte: {{ $DoubleDeepJoistBox25S->camber }}<br>
                                                Peso en Kg: {{ $DoubleDeepJoistBox25S->weight_kg }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepJoistBox25S->m2 }}<br>
                                                Largo: {{ $DoubleDeepJoistBox25S->length }}<br>
                                                Patín: {{ $DoubleDeepJoistBox25S->skate }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepJoistStructurals)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistStructurals->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistStructurals->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Viga tipo Estructural Calibre {{ $DoubleDeepJoistStructurals->caliber }} con las siguientes características:<br>
                                                Capacidad de Carga: {{ $DoubleDeepJoistStructurals->loading_capacity }}<br>
                                                Largo en Metros: {{ $DoubleDeepJoistStructurals->length_meters }}<br>
                                                Peralte: {{ $DoubleDeepJoistStructurals->camber }}<br>
                                                Peso en Kg: {{ $DoubleDeepJoistStructurals->weight_kg }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepJoistStructurals->m2 }}<br>
                                                Largo: {{ $DoubleDeepJoistStructurals->length }}<br>
                                                Patín: {{ $DoubleDeepJoistStructurals->skate }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepJoistC2S)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistC2S->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistC2S->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Viga tipo C 2.0 Calibre {{ $DoubleDeepJoistC2S->caliber }} con las siguientes características:<br>
                                                Capacidad de Carga: {{ $DoubleDeepJoistC2S->loading_capacity }}<br>
                                                Largo en Metros: {{ $DoubleDeepJoistC2S->length_meters }}<br>
                                                Peralte: {{ $DoubleDeepJoistC2S->camber }}<br>
                                                Peso en Kg: {{ $DoubleDeepJoistC2S->weight_kg }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepJoistC2S->m2 }}<br>
                                                Largo: {{ $DoubleDeepJoistC2S->length }}<br>
                                                Patín: {{ $DoubleDeepJoistC2S->skate }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepJoistLrs)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistLrs->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistLrs->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Viga tipo LR Calibre {{ $DoubleDeepJoistLrs->caliber }} con las siguientes características:<br>
                                                Capacidad de Carga: {{ $DoubleDeepJoistLrs->loading_capacity }}<br>
                                                Largo en Metros: {{ $DoubleDeepJoistLrs->length_meters }}<br>
                                                Peralte: {{ $DoubleDeepJoistLrs->camber }}<br>
                                                Peso en Kg: {{ $DoubleDeepJoistLrs->weight_kg }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepJoistLrs->m2 }}<br>
                                                Largo: {{ $DoubleDeepJoistLrs->length }}<br>
                                                Patín: {{ $DoubleDeepJoistLrs->skate }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepJoistChairs)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistChairs->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepJoistChairs->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Viga tipo Silla Calibre {{ $DoubleDeepJoistChairs->caliber }} con las siguientes características:<br>
                                                Capacidad de Carga: {{ $DoubleDeepJoistChairs->loading_capacity }}<br>
                                                Largo en Metros: {{ $DoubleDeepJoistChairs->length_meters }}<br>
                                                Peralte: {{ $DoubleDeepJoistChairs->camber }}<br>
                                                Peso en Kg: {{ $DoubleDeepJoistChairs->weight_kg }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepJoistChairs->m2 }}<br>
                                                Largo: {{ $DoubleDeepJoistChairs->length }}<br>
                                                Patín: {{ $DoubleDeepJoistChairs->skate }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepCrossbars)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepCrossbars->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepCrossbars->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                {{ $DoubleDeepCrossbars->type }} con las siguientes características:<br>
                                                Fondo: {{ $DoubleDeepCrossbars->depth }}<br>
                                                Desarrollo: {{ $DoubleDeepCrossbars->developing }}<br>
                                                Largo: {{ $DoubleDeepCrossbars->long }}<br>
                                                Calibre: {{ $DoubleDeepCrossbars->caliber }}<br>
                                                Kg x M<sup>2</sup>: {{ $DoubleDeepCrossbars->kg_m2 }}<br>
                                                Peso: {{ $DoubleDeepCrossbars->weight }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepCrossbars->m2 }}<br>
                                                Conector: {{ $DoubleDeepCrossbars->connector }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepSpacers)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{ $Partida }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepSpacers->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepSpacers->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Distanciadores con las siguientes características:<br>
                                                Uso: {{ $DoubleDeepSpacers->use }}<br>
                                                Desarrollo: {{ $DoubleDeepSpacers->developing }}<br>
                                                Largo: {{ $DoubleDeepSpacers->long }}<br>
                                                Calibre: {{ $DoubleDeepSpacers->caliber }}<br>
                                                Kg x M<sup>2</sup>: {{ $DoubleDeepSpacers->kg_m2 }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepSpacers->m2 }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepFloors)
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{$Partida}}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepFloors->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepFloors->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Piso con las siguientes características:<br>
                                                Largo: {{ $DoubleDeepFloors->length }}<br>
                                                Peso: {{ $DoubleDeepFloors->weight }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepFloors->m2 }}<br>
                                                Peralte: {{ $DoubleDeepFloors->camber }}<br>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($DoubleDeepFloorReinforcements)
                                    @php 
                                        $Partida = $Partida+1;
                                        if($Partida == 6){
                                            echo '</tbody></table></p></div></div></div></main><div class="pagebreak"></div><main>
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="border: solid 1px">{{$Partida}}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepFloorReinforcements->sku }}</td>
                                            <td style="border: solid 1px">{{ $DoubleDeepFloorReinforcements->amount }}</td>
                                            <td style="border: solid 1px">PZA</td>
                                            <td style="border: solid 1px" class="text-start text-xs">
                                                Refuerzo para Piso con las siguientes características:<br>
                                                Altura: {{ $DoubleDeepFloorReinforcements->height }}<br>
                                                Peso: {{ $DoubleDeepFloorReinforcements->weight }}<br>
                                                M<sup>2</sup>: {{ $DoubleDeepFloorReinforcements->m2 }}<br>
                                            </td>
                                        </tr>
                                    @endif                                    
                                </tbody>
                            ...
                            <table class="table table-striped table-bordered text-xs" style="border: solid 1px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-justify" style="border: solid 1px">
                                            Servicio de instalación en su planta de un sistema de Rack Doble Profundidad en base a 
                                            nuestro plano $Var Revisión 0.
                                        </td>
                                        <td class="text-end" style="border: solid 1px">$ {{ number_format($Quotations->installation_price, 2) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end" style="border: solid 1px">$</td>
                                    </tr>   
                                </tbody>
                            </table>
                        </p>
